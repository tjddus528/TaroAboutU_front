...
function SelectOneTaro({navigation}){
    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <View style={styles.card}>
                <CardArr/>
                <View
                style={{bottom:100}}><Button onPress={()=> {navigation.navigate('ResultOneTaro')}} title='next' color={"white"}/></View>
